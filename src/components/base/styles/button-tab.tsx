...
const commonStyles = (theme: Theme) => ({
  ...
  "&::after": {
    ...
    bottom: -2,
    left: 0,
    background: theme.palette.mode === "dark" ? lighten(theme.palette.neutral[900], 0.035) : theme.palette.common.white,
  },
  "&:hover": {
    color: theme.palette.mode === "dark" ? theme.palette.neutral[200] : theme.palette.neutral[900],
    borderColor: theme.palette.mode === "dark" ? alpha(theme.palette.neutral[700], 0.5) : theme.palette.neutral[400],
    background: theme.palette.mode === "dark" ? alpha(theme.palette.background.paper, 0.6) : theme.palette.common.white,
  },
  "&.Mui-selected": {
    color: theme.palette.mode === "dark" ? theme.palette.neutral[25] : theme.palette.neutral[900],
    background: theme.palette.mode === "dark" ? lighten(theme.palette.neutral[900], 0.035) : theme.palette.common.white,
    borderColor: theme.palette.mode === "dark" ? alpha(theme.palette.neutral[600], 0.4) : theme.palette.neutral[400],
    "&::after": {
      height: 2,
    },
  },
